 ...
 * @author Saurabh
 */
public class ManageAnalystEmployeeJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageAnalystEmployeeJPanel(JPanel userProcessContainer,OrganizationDirectory organizationDir) {
        initComponents();
    ...
    public void populateOrganizationComboBox(){
        ...
        for (Organization organization : organizationDir.getOrganizationList()){
            if(organization.getOrganizationType().getValue().equals(Organization.Type.Analyst.getValue())){
