 ...
 * @author Saurabh
 */
public class ManageAnalystUserAccountJPanel extends javax.swing.JPanel {
    ...
    public ManageAnalystUserAccountJPanel(JPanel container, Enterprise enterprise,EcoSystem business) {
        initComponents();
    ...
    public void popOrganizationComboBox() {
        ...
        for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()) {
            if(organization.getOrganizationType().equals(Organization.Type.Analyst)){
