...
public class EditPatientJPanel extends javax.swing.JPanel {
    ...
    public EditPatientJPanel(JPanel userProcessContainer,Patient patient,Enterprise enterprise) {
        initComponents();
        ...
        patientFirstNameJTextField.setText(patient.getFirstName());
        lastNameJTextField.setText(patient.getLastName());
        emailAddressJTextField.setText(patient.getEmailAddress());
        dateOfBirth.setDate(patient.getDateOfBirth());
        contactJTextField.setText(patient.getContactNumber());
        initialDisable();
...
//        }
    ...
    public void initialDisable(){
        ...
        patientFirstNameJTextField.setEnabled(false);
        lastNameJTextField.setEnabled(false);
        emailAddressJTextField.setEnabled(false);
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Edit Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 20))); // NOI18N
        ...
        searchJButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/Icons/Other-Search-alt-Metro-icon.png"))); // NOI18N
        ...
        updateJButton.setBackground(new java.awt.Color(0, 0, 0));
        updateJButton.setForeground(new java.awt.Color(255, 255, 255));
        updateJButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/Icons/update.png"))); // NOI18N
        ...
        if(gender==null){
         ...
         //||cancerType.length()==0
          if(firstName.length()==0|| lastName.length()==0 ||emailAddress.length()==0 || contactNumber.length()==0||dateOfBirth.getDate()==null){
                ...
                JOptionPane.showMessageDialog(null, "Patient details updated", "Info", JOptionPane.INFORMATION_MESSAGE);
...
//            JOptionPane.showMessageDialog(null, "Donor Added.", "Info", JOptionPane.INFORMATION_MESSAGE);
    ...
    public void enableToEdit(){
        patientFirstNameJTextField.setEnabled(true);
        lastNameJTextField.setEnabled(true);
        emailAddressJTextField.setEnabled(true);
